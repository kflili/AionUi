...
const AgentCliSettings = React.lazy(() => import('@renderer/pages/settings/AgentCliSettings'));
    ...
    <HashRouter>
      <Routes>
        ...
        <Route element={<ProtectedLayout layout={layout} />}>
          ...
          <Route path='/settings/agent-cli' element={withRouteFallback(AgentCliSettings)} />
